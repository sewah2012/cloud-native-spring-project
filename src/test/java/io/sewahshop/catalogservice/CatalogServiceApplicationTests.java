 ...
 .baseUrl(keycloakContainer.getAuthServerUrl()
	...
	void whenPutRequestThenBookUpdated() {
		...
		Book createdBook = webTestClient
				...
				.expectBody(Book.class).value(book -> assertThat(book).isNotNull())
				.returnResult().getResponseBody();
				var bookToUpdate = new Book(createdBook.id(), createdBook.isbn(), createdBook.publisher(), createdBook.title(), createdBook.author(), 7.95,
				 createdBook.createdDate(), createdBook.lastModifiedDate(), createdBook.createdBy(), createdBook.lastModifiedBy(), createdBook.version());
